...
# Когда Линукс выдает какойто вывод на экран то делает это в 2х потоках:
# то что нормально вывелось (>)
# то где есть ошибки или доступ закрыт (2>)
# Можно их разделить переправив вывод одного из потоков вникуда или в какой-то фаил
...
# > - команда перенаправляет поток вывода 1 в фаил, а в консоле отображает только вывод ошибок. Перезаписывает фаил полностью, те предварительно стирает все содержимое, создает новый фаил если он не существует
