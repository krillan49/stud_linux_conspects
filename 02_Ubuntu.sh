...
# Время и дата - можно отключить сообщения или наоборот повесить напоминания на какието даты
# Переключение языка
...
# "Настройка экранов" и справа в подпункте "Разрешение" можем поменять разрешение(например 1920x1080(16:9))
# "Фон" и двойным нажатием по картинке можем изменить картинку главного экрана
