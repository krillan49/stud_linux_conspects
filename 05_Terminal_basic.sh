...
# Терминал - это програама позволяющая запускать оболочку/shell например zsh или bash
...
# Необходимо настроить недостающие хоткеи
# https://stackoverflow.com/questions/6205157/how-to-set-keyboard-shortcuts-to-jump-to-beginning-end-of-line
# какаято_кнопка зажата + стрелки_влево_вправо      - перейти в начало строки или перейти в конец строки
