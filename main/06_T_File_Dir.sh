...
# $ mv aaa ccc                            - перемещение директории aaa в ccc (если директория ccc существует, иначе переименует aaa в ccc)

# $ mv file.txt .file.txt                 - переименование файла file.txt в .file.txt (тоесть скрытый)
# $ mv aaa ccc                            - переименование директории aaa в ccc (если директории ccc не существует, иначе переместит aaa в ccc)
