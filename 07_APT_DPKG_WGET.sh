...
# 4. apt-cache policy - команда которая ищет пакет(приложкение) на вашем ПК и выдает инфу есть ли на компе и если нет инфу где можно скачать и предпочтит версию
