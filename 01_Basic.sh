...
# Linux Mint Cinnamon Edition English
# почему нужен английский Линукс:
# если возникает ошибка, то легче гуглится, а разных ошибок будет очень много за время обучения и карьеры, плюс быстрее они решаются, т.к. на английском инфы больше
