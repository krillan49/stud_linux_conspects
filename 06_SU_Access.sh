...
echo "                              Права доступа. Смена прав и владельца фаила"
...
# 0. w - команда которая показывает инфу обо всех пользователях, что подключены к серверу/нашему компу, время подключения итд
