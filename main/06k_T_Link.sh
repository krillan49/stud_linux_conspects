...
# Линки-ярлыки(simbolic link/симлинк) - можно создавать для фаилов и папок и при исполнении или применении к ним команд cd, cat, nano и похожих, эти команды применятся к исходному фаилу или папке.
